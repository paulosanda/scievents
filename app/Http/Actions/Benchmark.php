...
/*
  PHP Benchmark
  Downloaded from: https://onlinephp.io
 */
...
//        dd($_SERVER);
        ...
        echo "<pre>$head\n|" . str_pad("PHP BENCHMARK",
                38, " ", STR_PAD_BOTH) . "|\n$head\nStart : "
            . date("m/d/Y H:i:s a") . "\nServer : {$_SERVER['SERVER_NAME']}@{$_SERVER['REMOTE_ADDR']}\nPHP version : " . PHP_VERSION . "\nPlatform : " . PHP_OS . "\n$head\n";
    ...
    function benchmark_Math($runCount = 150000)
    {
        ...
        $functions = array("abs", "acos", "asin", "atan", "bindec", "floor", "exp", "sin", "tan",  "is_finite", "is_nan", "sqrt");
